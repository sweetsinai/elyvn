...
async def score_lead(
    ...
    try:
        ...
        try:
            ...
            logger.error("Unexpected error in lead scoring: %s", e)
        ...
        logger.error("score_lead failed: %s", e)
        return {"error": f"Failed to score lead: {str(e)}"}
...
async def analyze_call(
    ...
    try:
        ...
        logger.error("analyze_call failed: %s", e)
