...
async def check_calcom_bookings(
    ...
    try:
        ...
        try:
            ...
            return {"error": f"Cal.com API error: {str(e)}"}
    except Exception as e:
        logger.error("check_calcom_bookings failed: %s", e)
        return {"error": f"Failed to check bookings: {str(e)}"}
...
async def cancel_booking(
    ...
    try:
        ...
        logger.error("cancel_booking failed: %s", e)
        return {
            "booking_id": booking_id,
            "status": "failed",
