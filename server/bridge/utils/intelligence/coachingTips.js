/**
 * Conversation Intelligence — Coaching Recommendations
 *
 * Generates actionable coaching tips based on call stats,
 * booking rates, response times, sentiment, and peak hours.
 */

const { getPeakHours } = require('./callAnalysis');
